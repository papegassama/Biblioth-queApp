...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        livreAdapter.setOnItemLongClickListener((livre, position) -> {
    ...
    private void ajouterLivresInitiaux() {
        executorService.execute(() -> {
            ...
            database.livreDao().insert(new Livre(0, "La Peste", "Albert Camus", "9782070360402", false));
            database.livreDao().insert(new Livre(0, "Sous l'orage", "Seydou Badian", "9782708707691", true));

            runOnUiThread(() -> chargerLivresDepuisRoom());
        });
    }
